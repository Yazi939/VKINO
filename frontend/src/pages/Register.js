...
const RegisterImage = styled.div`
  flex: 1;
  background-image: url('/images/cinema-register.jpg');
...
const Register = () => {
  ...
  return (
    <RegisterContainer>
      <RegisterImage>
        <ImageContent>
          <ImageTitle>Присоединяйтесь к VKino</ImageTitle>
          <ImageText>
            Создайте аккаунт, чтобы получить доступ к бронированию билетов, 
